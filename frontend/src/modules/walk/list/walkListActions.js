...
import exporterFields from 'modules/walk/list/walkListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'WALK_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await WalkService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.walk.exporterFileName'),
