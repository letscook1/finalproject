const en = {
  ...
  entities: {
    walk: {
      ...
      label: 'Walks',
      menu: 'Walks',
      exporterFileName: 'walk_export',
      list: {
        menu: 'Walks',
        title: 'Walks',
      },
      create: {
        success: 'Walk saved successfully',
      },
      update: {
        success: 'Walk saved successfully',
      },
      destroy: {
        success: 'Walk deleted successfully',
      },
      destroyAll: {
        success: 'Walk(s) deleted successfully',
      },
      edit: {
        title: 'Edit Walk',
      },
  ...
  roles: {
    ...
    walkEditor: {
      label: 'Walk Editor',
      description: 'Edit access to Walks',
    },
    walkViewer: {
      label: 'Walk Viewer',
      description: 'View access to Walks',
    },
    petEditor: {
      label: 'Pet Editor',
