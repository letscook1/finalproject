const ptBR = {
  ...
  entities: {
    walk: {
      ...
      label: 'Walks',
      menu: 'Walks',
      exporterFileName: 'Walk_exportados',
      list: {
        menu: 'Walks',
        title: 'Walks',
      },
      create: {
        success: 'Walk salvo com sucesso',
      },
      update: {
        success: 'Walk salvo com sucesso',
      },
      destroy: {
        success: 'Walk deletado com sucesso',
      },
      destroyAll: {
        success: 'Walk(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar Walk',
      },
      ...
      view: {
        title: 'Visualizar Walk',
      },
      importer: {
        title: 'Importar Walks',
        fileName: 'walk_template_importacao',
        hint:
  ...
  roles: {
    ...
    walkEditor: {
      label: 'Editor de Walks',
      description: 'Acesso de edição aos Walks',
    },
    walkViewer: {
      label: 'Visualizador de Walks',
      description: 'Acesso de visualização aos Walks',
    },
    petEditor: {
