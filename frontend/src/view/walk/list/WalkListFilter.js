...
class WalkListFilter extends Component {
  componentDidMount() {
            ...
            return (
              <Form onSubmit={form.handleSubmit}>
                <Row gutter={24}>
                  ...
                  <Col md={24} lg={12}>
                    <DatePickerRangeFormItem
                      name={fields.locationRange.name}
                      label={fields.locationRange.label}
                      layout={formItemLayout}
                      showTime
                    />
                  </Col>
...
export default withRouter(connect(select)(WalkListFilter));
