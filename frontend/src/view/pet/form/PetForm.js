...
import WalkAutocompleteFormItem from 'view/walk/autocomplete/WalkAutocompleteFormItem';
          ...
          render={(form) => {
            return (
              <Form onSubmit={form.handleSubmit}>
                ...
                />
                <WalkAutocompleteFormItem
                  name={fields.walks.name}
                  label={fields.walks.label}
                  required={fields.walks.required}
                  mode="multiple"
                />
